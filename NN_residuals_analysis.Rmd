...
g <- ggplot(number_o_ones) + 
  ...
  geom_point(aes(x=reorder(Index, -ones), y = loglosses * scaling_ratio)) +
  geom_point(aes(x=reorder(Index, -ones), y = xgb_lls * scaling_ratio), col='green') +
  geom_point(aes(x=reorder(Index, -ones), y = linear_lls * scaling_ratio), col='orange') +
